# Weekly Dive Report — Data Products & Templates

End-of-week deliverables Bret asks for. Produced from the week's logged dive reports
(see `dive-log.md`) + tool predictions + offshore/fish intel + moon phase. Git-tracked so
the format, voice, and past examples are never lost.

## The three products
1. **Facebook post** — the long-form "California Dive Report — Week of [dates]" (full narrative).
2. **Instagram post** — a condensed, punchy version of the same.
3. **Weekly subscriber email** — subject-line options + preheader + region breakdown, signed by Bret.
...
Color = the week's overall water quality for that region: 🟢 clean/blue · 🟡 moderate/mixed · 🔴 rough/blown out.
- 🟢/🟡/🔴 **SAN DIEGO / LA JOLLA** (Cove, Marine Room, Shores, Point Loma kelp; + offshore: Coronado Is, 9 Mile Bank, the 302)
- **ORANGE COUNTY / LAGUNA** (Shaw's, Treasure Island, Woods Cove, Goff/Crescent, Newport/Pirates Cove)
- **LA / SOUTH BAY** (Palos Verdes, Redondo/Veterans Park)
- **CENTRAL COAST (Carmel / Pt Lobos)** (Monastery, Cypress Pt, Beto's Reef)
- **MONTEREY BAY** (Breakwater/"the wall", McAbee, Mt Chetron, boat pinnacles)

### Recurring content beats
- **Per region:** narrative with specific spots, dates (M/D), viz ranges in ft, water temps in °F, thermocline depth. Bulleted tactical tips. A 🐟 fish/offshore line where relevant.
- **🌡️ Marine Heatwave / oceanography explainer:** adapt to the week's actual pattern — warm murky surface lens over cold clean upwelled water, upwelling driven by NW winds + North Pacific High, blooms greening the surface, "read the whole water column / plan for bottom temp." 
- **🌑 Moon & WSB:** moon phase + white-seabass deep flat-fall/iron bite tie-in.
- **WILDLIFE NOTES:** notable critters (leopard sharks, bat rays, GPO, GSB/black sea bass, sevengill, nudibranchs, etc.).
- **🔗 conditions.spearfactor.com** link + "Dive safe!"
- **Hashtags** on social (e.g. #spearfishing #californiadiving #spearfactor #lajolla #diveconditions #freediving #marineheatwave).

### Voice
Knowledgeable, tactical, conversational — a well-informed spearo talking to other divers. Specific
(named spots, dates, numbers), pattern-literate (gradients, thermoclines, swell direction/period,
upwelling), and practical (what to dive, when, where's sheltered in swell). The email is signed "Bret / SpearFactor."

### Email skeleton
- Subject line options (offer a few, "pick one")
- Preheader / preview text
- "Hey divers," + theme paragraph
- WILDLIFE NOTES
- THE WEEK BY REGION (same regions/emojis/bullets)
- FISH AND OFFSHORE INTEL
- THE MARINE HEATWAVE — read the whole water column
- 🌑 MOON & (KING) TIDES
- Real-time predictions: conditions.spearfactor.com
- "Dive Safe, Bret / SpearFactor"
...
#spearfishing #californiadiving #spearfactor #lajolla #palosverdes #malibu #laguna #pointlobos #diveconditions #freediving #elnino

### WEEKLY EMAIL — Week of September 14–20, 2026 (Bret's voice; every logged report included; offshore intel paraphrased, no source)
**Subject line options (pick one):**
- The week the warm water came back (and Malibu hit 50 ft)
- Green murk to gin-clear — your Sept 14–20 dive report
- Warm on top, clean underneath: read the whole column

**Preheader:** The cold roll let go, 73–74°F came back, and the South Bay/Malibu outer reefs went gin-clear (Malibu hit 50 ft).

Hey divers,

If you sat this week out, you missed the turn. Last week the whole coast looked like a lava lamp — cold, green, upwelled water everywhere. This week it let go. The surface warmed back to 73–74°F, San Diego and Laguna scrubbed themselves clean, and the South Bay and Malibu outer reefs went flat-out gin-clear. Offshore, El Niño kicked the door in — world-class marlin, and the thing that still surprises me, wahoo in our own local water. Here's the one habit that would've paid off no matter where you dove: go early, and go deep. Mornings were glass before the sea breeze chopped up the shallows, and just about everywhere the murk sat up top while the clean water waited below and outside. Let me walk you through it region by region.

🐙 WILDLIFE NOTES
Leopard sharks and three baby horn sharks tucked into the Marine Room shallows; lobsters and night-time bioluminescence lighting up Mission Bay; a harbor seal, a leopard shark, a baby bat ray and a round ray all working Goff Cove; schools of blue rockfish under the Point Lobos kelp and a big ~1.2 m lingcod in Carmel (a personal best for that diver); and rubberlip perch and garibaldi stacked up at MPP.

🌊 THE WEEK BY REGION

🟡 SAN DIEGO / LA JOLLA — started green, ended clean (with two holdouts).
Monday and Tuesday were a mess — the shops were calling 5–10 ft with a ton of suspended particulate, and there was a sediment plume you could see smeared off the Marine Room from the air. But it cleaned up a little more every day as the swell dropped and the water warmed. By the weekend, La Jolla Shores was a solid 15–20, with 30+ if you swam out between the buoys (one diver saw the bottom out there). The Cove came back to the mid-teens, with "some viz" reported out at the quarter and half-mile buoys. A Wednesday-night Shores dive laid the gradient out perfectly — cloudy close to shore, cleaner as you worked outward, then surgy again once you got down deep. Two holdouts worth knowing:
- Marine Room is the laggard. That shallow sandy flat sits right at the head of the La Jolla canyon, so it acts like a sediment factory and holds the murk longest — single-digit pea-soup most mornings and again at high tide (one diver couldn't see his own toes). Don't fight it: drop down and swim for the buoys and it opens up to a clean 15–20.
- Point Loma was the wild card. A clean 15–20 out by the Whistler midweek, down to about 8 ft one evening, and back to ~10–15 by Sunday. Take that one hour by hour.
Mission Bay (MPP) ran the usual jetty split — murky 5–10 up in the shallow bay, but great out in the channel, with lobsters around and bioluminescence firing at night. Water's a warm 73°F.

🟢 LA / SOUTH BAY — the clear water of the week.
The outer reefs went off. Palos Verdes' Flat Rock ran a gin-clear 25–30 ft at 74°F, and up at Malibu a diver hit a jaw-dropping 50 ft on the outer reef — the catch being you had to punch through the milky "milkshake" of erosion murk on the inside to get to it. Veterans Park went 20–30 on a Wednesday night. That inside-vs-outside split is the whole game up here: the shallow sandy inside can be a blown-out mess while the outer reef is straight glass. And it all hinges on the current — these points rip, so clarity comes and goes with the slack. Time it right and it's the best water in the state.

🟡 ORANGE COUNTY / LAGUNA — coves came back, the exposed stuff got worked.
The Laguna coves cleaned up to a nice 15–20 ft — Crescent, Shaw's, and Diver's — and if you kicked out toward Whiskey and Emerald it got even better on the deeper reef. Crystal Cove ran a steady 15. Those "beautiful in the sun" days are back. The exception was the exposed South-Laguna stuff on the SW groundswell: Goff was a hazy-but-fishable 15–20 most days and absolutely loaded with life (a sleeping harbor seal, a leopard shark, a baby bat ray, a round ray, kelpfish), but at the peak of the swell midweek Treasure Island and Goff went murky and rough — under 10 ft with 3–5 ft waves at 75°F — before bouncing right back. On a swell down here, pick the sheltered coves and get below the surge. (If you want the full lay of the land, I just published a complete OC dive-site guide — see below.)

🟡 CENTRAL COAST (Carmel / Point Lobos) — hazy up high, better down low, and warm.
Lobos and Carmel ran 15–25 ft — hazy in the cove and shallows, and cleaner the deeper you went. Beto's was 10–15 opening up to 20–25 out along Middle Reef; Rock Garden ran 15–20; Monastery was hazy up top and better down deep. The real headline was the heat — unusually warm water, downright tropical for Carmel. Life was good, with schools of blue rockfish under the kelp and that big ~1.2 m lingcod. And a gut-punch note from a diver over at Monolobo: almost all the old kelp is gone, urchin-barren since the sea stars died off in 2014 — a patch of Giant Kelp is a rare find there now.
...
🔵 NORTH COAST (Sonoma / Mendocino) — laying down and cleaning up.
Good news up north: the ocean's relaxing and clearing from Fort Bragg down to the Sonoma coast. Salt Point ran 20–25 once you got outside, and divers were in the water at Windemere Point and Still Water Cove finding 10–15 in the rockier areas. It's patchy right at the shore, though — Shell Beach was murky the same day Salt Point was clean — so the good water's on the outer, more protected structure. Cold-water gear, as always.

📚 NEW ON THE BLOG THIS WEEK
- The Orange County Dive Site Guide: Laguna Beach and Beyond, North to South (spearfactor.com/post/the-orange-county-dive-site-guide-laguna-beach-and-beyond-north-to-south) — OC packs a lifetime of diving into a short stretch of coast. This is the full run-down, spot by spot, north to south — a perfect companion to this week's Laguna report.
- Two Weeks to the Lobster Opener: A Diver's Prep Checklist (spearfactor.com/post/two-weeks-to-the-lobster-opener-a-diver-s-prep-checklist) — bug season opens in early October. Here's how to get your gear, your spots, and your paperwork squared away so you're not scrambling on opening night.

🐟 FISH & OFFSHORE INTEL
Might be the fishiest late-September I can remember. Striped marlin everywhere — Anacapa's east end, the 43 Fathom Spot, the Osborn, down to the Coronados (a diver landed a 100-pounder off the Coronado Islands this weekend). Wahoo have moved into local water — Newport Canyon and off Laguna. Wide-open yellowfin 8–10 mi off the Domes, better 10–60 lb fish at the Osborn, dorado on the paddies. Bluefin are way out (~130 mi). Live bait is everything and the barges are thin — get there early. With warm-water strays around, photograph anything out of place and send it to Scripps' unusual-fish project. And check closures/regs with CDFW and the local authority before you go.

🌡️ THE MARINE HEATWAVE — warm on top, read the column
The cold upwelling pulse let go and the warm surface came roaring back (73–74°F south, strikingly warm at depth in Carmel). Warm water clears the nearshore green but leaves a haze on the surface and reef sitting over cleaner water below — that's why "read it deep" was the move all week, and why the South Bay outer reefs had such a dramatic inside-vs-outside split.

🌑 MOON & TIDES
Waxing crescent, modest tides — but honestly the pattern that mattered was daily, not lunar: glassy mornings, an afternoon NW sea breeze stirring the shallows, and incoming tides pushing cleaner water in. Dive early, and if the shallows are churned, the clean water's a little deeper or a little farther out.

📊 HOW THE TOOL DID
A good week, and here's the honest scorecard. It tracked the San Diego clean-up in near real time — dropped the numbers as the murk rolled in, then walked them back up as it cleared — and it read the Laguna coves, Crystal Cove, Point Lobos, Monterey's deep stuff, and the Marine Room mornings dead-on. Two newer features earned their keep: the Scripps pier-cam adjustment (lining up with the shop's cam calls at the Shores) and the shallow-vs-deep "visibility by position" bar (nailing the surgy coves). Where it missed, it mostly missed safe — it lowballed the South Bay/Malibu outer reefs on their gin-clear slack-current days (called high-teens when Malibu's outer reef was 50), but I'd rather under-promise than send you out on a current-blown afternoon, so we flag the upside instead. The honest over-calls to own: it read Treasure Island/Goff a touch high on the midweek groundswell (a cove that swings more than the data can see), and it floated the Marine Room high at one high tide when the local pocket stirred up (our nearest sensor's ten miles away and can't see it). We also shipped a fix so that shallow/deep bar only shows where it's trustworthy (the SoCal surge coves) and stays hidden up on the Central Coast, where the deep flips clear-or-murky day to day.

🔗 Real-time predictions any day: conditions.spearfactor.com

Dive safe — warm water, early mornings, and read it deep.
Bret / SpearFactor
...
### WEEKLY EMAIL — Week of August 10–16, 2026 (FULL detailed draft; generic, no individual reports named; offshore intel paraphrased, no source)
Subject line options (pick one):
- A tale of two coasts: La Jolla blows out, Monterey's bloom finally breaks — Dive Report Aug 10–16
- Clear → hazy → blown in the south, gin-clear up north — California Dive Report Aug 10–16
- The week the bloom broke in Monterey (and our forecast made its first "camera save")
Preheader (preview text): La Jolla went clear, then hazy, then blown out by a weekend swell. Monterey's weeks-long bloom finally cleared and the water opened way up. Same heatwave, opposite results — plus how the forecast scored and where to dive next.

Hey divers,

Here's what California waters did this week — the full rundown, region by region, plus an honest look at how the forecast scored and where things are heading.

The big theme was a coast that couldn't make up its mind in the south, and a Central Coast that finally did up north. La Jolla opened the week gin-clear (20–30 ft of warm blue on the calm mornings), caught a thin surface haze midweek that the shallows just couldn't shake, then a long-period weekend swell rolled in and blew the whole cluster out to a surgy 5–13 ft by Sunday. Up in Monterey and Carmel the script flipped entirely: the stubborn green surface bloom that's dogged the region for weeks finally scoured out, and the water opened way up — 40–50+ ft at the deeper spots. Same marine heatwave underneath it all, opposite results — a warm surface lens sitting on cold, clean, upwelled water, and it all came down to wind and coastline.

WILDLIFE NOTES: A big week for the charismatic stuff. Leopard sharks were all over La Jolla — including a dense "nursery" of them stacked in the sandy shallows just north of the Marine Room, in about 3 ft of gin-clear water — along with giant sea bass, sea turtles, and soupfin (tope) sharks, and yellowtail cruising the Marine Room reef. Up in Monterey and Carmel: impressively thick clouds of mysid shrimp carpeting the shallows, a fresh basket star find at Point Lobos, and a sea-lion migration from the Channel Islands staging on San Carlos Beach right at the Breakwater (a noisy bull hauled out mid-beach — give them a wide berth). Down at the Coronado Islands, yellowtail were on the chew.
...
🟡 ORANGE COUNTY / LAGUNA — surfy and swingy
A classic Laguna mixed bag that swung with the surf. On the calm mornings the sheltered spots ran up to ~20 ft (Goff, 8/11), but whenever the surf came up the exposed coves churned right down — Shaw's was 0–10 ft (8/13) and Crescent ran 10 ft on 3 ft of surf (8/14). And it came up more than it laid down. Same rule that always applies here: in swell, Treasure Island (Goff), Shaw's, and the tucked-in coves are your most sheltered bets, the deeper water past the surge holds better than the shallows, and afternoons often beat mornings once the tide settles.

🟢 LA / SOUTH BAY (Palos Verdes) — the quiet winner
The sleeper pick of the week. Flat Rock / Big Pipe cleaned up to a solid 20–25 ft by the weekend (8/16) — genuinely gin-clear water, warm 74°F top to bottom (barely any thermocline), and next to no current. While La Jolla was blowing out to the south, the South Bay quietly delivered the calm, clear, uncrowded diving. If you're up that way, it's been the most reliable clear water in SoCal.

🟢 CENTRAL COAST (Carmel / Pt Lobos) — the bloom finally broke
The week's best story. That stubborn green surface bloom finally cleared out and the water opened way up. Point Lobos ran blue-hazy with 30+ ft at depth midweek (8/13), then built to 20–30 ft up top opening to a gorgeous 40–50+ ft below the thermocline by the weekend; Monastery went 20–30 ft horizontal with 40+ ft of vertical clarity (8/15); and the pinnacles fired — MacAbee at 35 ft, Beto's Reef at 50+ (8/15). It's cold and clean up here — mid-50s to low-60s at the surface, colder below — so bring the thick suit. If you've been waiting out the summer pea soup on the Central Coast, this was the window, and it's holding.

🟢 MONTEREY BAY (Breakwater / McAbee) — following suit
The bay cleared right along with Carmel. The Breakwater climbed from a particulate ~10 ft midweek (8/11) to a hazy but real 20–30 ft by 8/12 and held into the weekend, glassy on the calm mornings. The nearby pinnacles were even better. Water ran 56–60°F with a chilly thermocline. A genuinely nice turnaround for Monterey shore diving. One heads-up: it's Car Week in Monterey and the in-town traffic has been brutal, so plan your timing around it.

🔵 CATALINA / CORONADO ISLANDS — big blue
Catalina held its usual big blue water, running 40+ ft. Down at the Coronado Islands (in Mexican waters) it was a hazy but solid 40 ft, best up at Pukie Point on the north island, with a sharp thermocline and a ripping current — and yellowtail biting for the divers who made the run.

HOW THE FORECAST DID THIS WEEK
An honest scorecard, since a few of you asked. Across the reports we could check against the tool, it matched what divers actually found on roughly 8 out of 10.
Where it was strong: it absolutely nailed the blown-out weekend — it flagged the incoming swell and had the entire La Jolla cluster pegged at a surgy 5–13 ft while divers were finding pea soup. It also tracked the Monterey bloom clearing in real time, climbing right alongside the water as it opened up. And it self-corrected a couple of times as the sensors caught up: a spot that read too high on a shadowed morning fell right into line by the afternoon once the wave-energy data updated.
Where it slipped, and what we did about it: the one real stumble was that midweek "stealth haze" at La Jolla. For a day, the pier sensor read gin-clear but a thin surface layer had actually moved in on top of it, so the tool briefly over-called — a sensor sitting at the pier simply can't see a thin haze floating above it. We took two swings at that this week. First, we capped the top end so the tool can't over-promise on an ultra-clean-sensor day. Second — the big one — we wired the Scripps Pier underwater camera in as a live clarity check. The camera is direct, eyes-on ground truth for how the water actually looks, so when it sees haze the sensor misses, it now pulls the estimate down to match. It made its first real save this Sunday, catching the blown-out Shores and adjusting the number down to what divers were actually seeing. That's the exact fix we've wanted all summer for that problem.
The only other misses were a couple of gin-clear days where the tool played it safe and read a touch low — Palos Verdes and Goff both hit ~25 ft while it called high-teens. We leave those alone on purpose: under-promising and getting pleasantly surprised beats over-promising and getting let down.

THE WEEK AHEAD — 7-DAY OUTLOOK
Where the tool has conditions heading into next week:
* San Diego / La Jolla: Rough. That long-period west swell (about 3 ft at 15 seconds) has the nearshore blown and surgy, and it's forecast to hang around — the Cove, Shores, and Marine Room are sitting at a poor 2–8 ft most of the week. Give it a few days; if you have to get wet, play the calm early mornings and go deep or offshore where the surge can't reach.
* Orange County / Laguna: Same swell, same story — the exposed coves stay churned at 2–7 ft all week. Sheltered spots and deeper water only.
* LA / South Bay (Palos Verdes): The steadier nearshore option and the cleaner of the SoCal picks lately — but this west swell wraps into the point too, so check it before you commit rather than assuming it's clean.
* Catalina: Holds up best of the SoCal options — 40+ ft early in the week, easing toward the low 30s later as a little swell fills in. Still your clear-water day trip in the south.
* Monterey / Central Coast: The real clear water right now. The bloom's gone and it's calm — Point Lobos and the pinnacles are running 40–50+ ft outside the cove. Fair warning: the tool's seasonal number runs conservative up here (it's showing low-20s softening to the mid-teens), but the actual water has been much better. The thing to watch is the NW wind — a few days of it cranking can reload the surface bloom fast.
Bottom line: SoCal's nearshore is surf-worked this week, so Catalina is your clear-water day trip in the south and Monterey/Carmel is the standout if you can make the drive.

FISH AND OFFSHORE INTEL
* The marlin showed up — and how. Some of the best striped marlin fishing in years is going off right now, thick around Catalina, through the channel, and out toward the 711, mostly in small wolf packs busting bait balls. Lots of catch-and-release.
* The yellowtail moved north out of San Diego and into Orange County and LA. The PV/Horseshoe area and the Dana Point–Oceanside stretch had the near-wide-open days, with standout fish in the 25–30+ lb class. San Diego and La Jolla got sketchier as the volume pushed up the coast, and the islands (Catalina, the Coronados) are slower and boat-shy right now.
* A wahoo turned up down south, within full-day range of Mission Bay. Dorado are scattered on the kelp paddies, the bluefin bite has slowed off (better at night now than during the day), and the squid have vanished with the warm water — which has the island white-seabass bite mostly off.

THE MARINE HEATWAVE — READ THE WHOLE WATER COLUMN
The heatwave is still running the show, and the whole story is in the vertical split:
* Surface: upper 60s to mid-70s in Southern California, mid-50s to low-60s in Monterey
* At depth: a clean, cold ~50–55°F — and that cold water is active upwelling
That contrast drove everything this week. Up in Monterey, a shift in the northwest wind let upwelling flush the surface bloom out — cold, clean water rises up the coast, greens out for a few days as the nutrients feed a plankton bloom, then clears when the wind pattern relaxes. That's exactly what broke the bloom this week; the tell is the NW wind, since a few days of it cranking can reload the green just as fast. Down in La Jolla, that same warm surface lens is what let a thin haze float right on top of a clean pier reading — the exact gap the new underwater-camera check is built to close. Practical takeaway: plan for the bottom temperature, not the surface, and expect to punch through a sharp thermocline either way. It's also why "go deeper" so often finds cleaner water — you're dropping below the warm, bloom-fed surface layer into the clean cold water underneath.

🌑 MOON
We came through the 8/12 new moon this week and we're building back into a waxing crescent. White seabass tend to favor the low-light edges around the new moon, so the darker early-week dawn and dusk windows were the smart play for anyone chasing them on the deep iron.

Stay safe and check the live conditions before you head out — that's what they're there for.
...
### WEEKLY EMAIL — Week of August 3–9, 2026 (detailed subscriber version; generic, no individual reports named, no fish-source named)
Subject line options (pick one):
- Clear and warm early, hazy and surfy late — California Dive Report, Aug 3–9
- Pick your spot by exposure: the week the shallows milked up and the deep ran clean
- How our visibility forecast did this week (about 7 in 10) — plus the full coast breakdown

Preheader (preview text): A warm week that rewarded the right spot — blue early, hazy and surf-churned late. Plus an honest look at how the forecast called it, region by region.

Hey divers,

Here's what California's water did this week — and, since a few of you have asked, an honest look at how well our visibility forecast actually called it.

The short version: warm water everywhere, and the visibility came down to picking the right spot on the right day. The first half of the week was the good stuff — clear, warm, blue water across Southern California. By the weekend two things shifted: a thin surface haze settled into the shallow, close-to-shore spots in the south, and a bump in surf churned the exposed reef coves. Through all of it the rule held — when the shallows looked milky, the cleaner water was deeper or a bit farther offshore.

WILDLIFE NOTES: A big week for the charismatic stuff. Giant sea bass, sea turtles, and leopard sharks around La Jolla, plus a garibaldi "nursery" of hundreds of tiny juveniles at Goldfish Point and yellowtail cruising the Marine Room reef. Up in Monterey/Carmel: gorgonians and anemones on the deep reefs, an angel shark, a red octopus out wandering in daylight, and a foot-long sea hare. A shark cruised the sand flats down in Laguna.

THE WEEK BY REGION

🟢 SAN DIEGO / LA JOLLA — clear early, hazy shallows late, still clean offshore
The week opened beautifully: 20–30 ft of warm, clean blue, with the Cove and Shores both well into the 20s and the reef visible straight through on the calmest mornings (surface 71–76°F). Midweek a subtle surface haze moved into the shallow, close-in spots — the Cove and nearshore reefs dropped to a milkier 5–15 ft, hazy toward the 1/4-mile buoy and murkier the farther south you swam, with the worst pockets (like Devil's Slide) down around 3–5 ft. But that haze was thin and shallow: head out over the deeper canyon water, roughly a half-mile offshore, and it was still a clean 25–30 ft of blue. Classic La Jolla — murky inside, clean outside and down. By the weekend the nearshore surface even cooled into the low 60s as a little upwelling kicked in.
Tip: on a hazy La Jolla day, swim out and drop down — the top few feet near shore are the worst of it.

🟡 ORANGE COUNTY / LAGUNA — a great start, then the surf showed up
The calm early-week days were genuinely nice — the more sheltered Laguna spots ran 15–25 ft. Then the weekend brought a jump in surf, and the shallow, SW-facing reef coves (which magnify wave energy) churned into a milky 4–15 ft. It was patchy: the middle of a cove might hold 10–15 ft while the exposed sides dropped to 5 ft or less, and mornings were worse than afternoons as the surf eased. Worth noting — this was surf-stirred sediment, not a plankton bloom, so the water was milky rather than green. Warm enough a few divers got away with a 3 mm instead of the usual 7.
Tip: on a surf day in Laguna, the sheltered spots and the deeper water hold up far better than the exposed coves — and it pays to wait for the afternoon.

🟡 LA / SOUTH BAY (Palos Verdes) — quiet underwater, loud on the fishing
No in-water visibility reports came in from the South Bay this week, so treat this as light. The tool had Palos Verdes in the low-to-mid teens of green-tinged water (a mild bloom over a warm 76°F surface). The real story here was the fishing — some of the best mixed-bag action of the year close to shore (see below).

🔵 CATALINA — the easy button
Flat, warm, and big blue water again — the calmest, clearest conditions in Southern California, with a stable mixed-bag fishery to match. If you wanted a sure thing this week, this was it.

🟢 CENTRAL COAST (Carmel / Point Lobos) — bloom on top, treasure below
A persistent summer plankton bloom kept the surface murky and green. On the deeper Carmel and Point Lobos sites the top of the water column was genuinely rough — often just 3–7 ft, dark and pea-soupy, enough that divers ran lights at midday. But the payoff was below: on several dives the water opened up under the cold layer (one tech dive actually found better visibility at 120 ft than up top). It was variable, though — on the roughest day even the depths stayed murky. Cold up here: mid-50s at the surface and colder below, so bring the thick suit.

🟢 MONTEREY BAY — the sheltered shallows saved the week
The Breakwater / Cannery Row side of the bay fished better than the open-water bloom would suggest. The sheltered, shallow spots ran roughly 10–15 ft, and more than one diver surfaced pleasantly surprised, having braced for worse. That gap — sheltered shallow water clearing better than the satellite bloom implies — is exactly what we tuned the tool for this week (more on that below). Surface in the mid-50s. (Local note: it's Car Week, and traffic in town has been brutal — plan around it.)

🔴 NORTHERN CALIFORNIA — fair
Roughly 6–8 ft up around Fort Bragg, a bit stirred by surf — decent for the North Coast, if not the "epic" some forecasts promised.

📊 HOW THE FORECAST DID THIS WEEK
You asked, so here's the honest scorecard. Across the reports we could check against the tool, it matched what divers actually found on about 7 out of 10 — low-to-mid 70s percent.
Where it was strong: the calm days (it nailed the clear early-week reads), and it correctly flagged the rough, surfy Orange County days before anyone got wet.
Where it slipped, and why:
• It played it safe on a couple of exceptionally gin-clear La Jolla days — reading the high teens when the water was really 25–30. When it's absolutely blue, the tool leans conservative.
• It can't yet "see" a stealth surface haze. A few days the pier sensor read clean but the shallow water had quietly gone milky — the sensor sits just below that thin surface layer. (This is exactly what an underwater-camera feed we're building is meant to catch.)
• Monterey needed a midweek tune-up: the tool was applying the open-bay bloom to the sheltered Breakwater, which clears better — we fixed it so it now matches the shallow, sheltered water and reminds you the deep may differ.
Bottom line: trust it most on calm days, lean on it to steer you off the rough ones, and give it a little grace when the water goes gin-clear.

🐟 FISH & OFFSHORE INTEL
Warm, blue offshore water kept the bite going all week. Tuna were the headline: bigger bluefin (20 to 200+ lb) held the cooler water out west, while smaller yellowfin (mostly 5–15 lb, a few bigger) pushed up close to home — within a few miles of the coast in places. Dorado (mahi) scattered on the floating kelp paddies in the warm water, and striped marlin showed around Catalina and the channel. Yellowtail kept biting around the islands (Catalina and the Coronados). Closer in, it was some of the best mixed-bag action of the year — loads of barracuda, plus bonito and bass up and down the coast, strongest in the LA/South Bay area. Two classic warm-water tells: the squid disappeared as temps climbed into the 70s, and live bait was hard to get all week.
...
🟡 SAN DIEGO / LA JOLLA — Peaked Friday, rough finish
A real rollercoaster. Midweek was on the mend (6/24: Cove murky under 10, Shores 10–15, Marine Room 10–15 hazy with fine particulate), then Friday 6/26 went off — La Jolla cleared to the best of the week: Cove 15–20+, Marine Room 20+ over the sand flats, Shores 15–25, gin-clear blue with the reef visible straight through. It didn't hold: by Saturday the surface was hazing back over (water temp dropped to 65°F as upwelling kicked in), and Sunday turned rough — Marine Room down to a murky 7–10 ft on onshore wind, and LJ Shores a surgy 5–10 ft under a long-period 18-second south swell.
- Classic inner-murk / outer-clean gradient again — shallows hazy, clearing as you moved out.
- Big vertical split all week: a warm, murky 65–68°F surface lens over genuinely CLEAN 51–52°F water at depth. At LJ Shores it was 5–15 ft through "greenish gunk" up top but 20–30 ft once you dropped below the 40 ft thermocline; the canyon ran ~10 ft above 50 ft and a clean 20–25 ft below it.
🐟 Fish: Yellowtail were on the La Jolla kelp beds inshore — one speared in the kelp at 20 ft on 6/24 (12–14 ft viz). Offshore, the 9 Mile Bank → the 302 went green nearshore but cleared to 100-ft blue past the bank, giving up two yellowtail to 25 lb on the 302 kelp paddies (6/26). At the Coronado Islands, though, the YT bite was OFF — the islands rolled over cold and green — while white seabass kept biting: two solid fish (33" and 34") landed on flat-falls on 6/26.

🟡 ORANGE COUNTY / LAGUNA — Swell-churned Newport, moderate Laguna
Newport took it on the chin early: Pirates Cove (Corona del Mar) was under 5 ft on 6/24 with 3-foot waves wrapping off the cliffs — a spot you'd hope the harbor would shelter, but it wasn't. Tucked-in pockets at a harbor mouth can actually fish worse in swell, since the waves reflect and churn off the rock. Laguna held up better midweek: Goff Cove ran 8–12 ft on 6/26 with a few clearer pockets to 15.
- In swell, the Laguna rule still applies — Treasure Island, Shaw's, and Woods Cove are your most sheltered bets, and Crescent Bay Park gives you a free look at Seal Rock and Shaw's before you commit.

🟡 LA / SOUTH BAY — Quiet week
Limited reports, but Palos Verdes was running ~10 ft early in the week (6/22).

🟢 CENTRAL COAST (Carmel / Pt Lobos) — Blue window closing
Last week's epic blue water started slipping back toward green as the bloom returned. North Monastery was 10–15 ft and a touch milky on 6/27, and the Pt Lobos coves held a hazy ~20 ft at depth on a flat-calm day (the resident giant Pacific octopus was home at Beto's). A scooter run from Pt Lobos toward Monastery found 20–40 ft at depth — 58°F up top, 52°F on the bottom. The cleanest water was deep; the surface was milking up.

🟢 MONTEREY BAY — Bloom band creeping back
The boat pinnacles still produced at depth, but the mid-water bloom is back. Mt Chetron opened up to 25 ft at the bottom and McAbee ran 10–20 ft with a yellow, snotty algae band stacked from 15–45 ft (6/26). A deep tech dive at Frenchies showed it in cross-section: clear-ish in the top 30 ft, nasty green algae 40–60 ft, then dark-but-clearer below.

🌡️ The Marine Heatwave Split — and what's driving the upwelling
Same heatwave, same lesson: read the whole water column. Surfaces are warm (65–70°F in San Diego, 56–58°F up north) sitting on cold 51–52°F water at depth — and that cold water is active upwelling.
What actually causes it: this time of year the North Pacific High parks offshore and drives persistent northwest winds down the California coast. Those winds, bent by the Earth's rotation, push the surface water offshore — and cold, nutrient-rich water from down deep rises up along the coast to replace it. That's upwelling, and that cold layer you hit at depth is exactly that water. It comes up cold and clear-blue at first, but within a couple of days the nutrients fuel a plankton bloom that greens the surface. So when the NW wind backs off, the bloom stops getting fed and the water can clear (Central CA last week); when it cranks back up, you get cold green water and dropping surface temps — which is what reasserted itself on both coasts this week. Wherever you dove, the cleanest water was below the warm surface lens.

🌑 Moon & WSB
Building toward the full moon (June 29). White seabass kept biting deep on the iron at the Coronados — two landed midweek even with the yellowtail shut off — so the deep flat-fall game stayed alive while the surface bite went quiet.

WILDLIFE NOTES: Bat rays out in big numbers at the Marine Room, with a leopard shark cruising the sand. A giant Pacific octopus holding court at Beto's Reef (Pt Lobos). At depth off LJ Shores: a huge shiner-perch school, young-of-year bocaccio, dozens of ocean whitefish, a yellowfin, and dolphins on the swim-out — plus a kelp perch in the canyon on Sunday. Central CA had blue rockfish, lingcod, and metridium, with salps and jellies drifting through the column.

🔗 Full spot-by-spot conditions and forecasts: conditions.spearfactor.com
Dive safe!

#spearfishing #scuba #californiadiving #spearfactor #lajolla #diveconditions #freediving #marineheatwave

### INSTAGRAM — Week of June 15–21, 2026
WILDLIFE:  La Jolla. Leopard sharks back on the Marine Room reef, plus sevengill, tope, and a rare prickly shark deep. Giant Black Sea Bass are showing up in big numbers as well in La Jolla cove.
🟡 SAN DIEGO → Rough start: 6/17 MR-to-Cove 0–5 ft "soup" (King-tide stirring + bloom). Recovered all week → Sun LJ Cove best day, 15–20 ft on the afternoon. Warm murky 65–68°F surface lens over CLEAN 51–52°F at depth (15–35 ft once you drop through). Pt Loma kelp 8–20 ft. Offshore: Coronado Is + 9 Mile Bank ~30 ft 🔥
🐟 YELLOWTAIL WIDE OPEN at LJ kelp 6/17 — tight ~7–9 AM window, 7 to 30+ lbs. Leopard sharks schooling MR reef Sat–Sun.
🔴 ORANGE COUNTY → Big 18s SOUTH swell hammered Laguna 6/16 — Shaw's 0–5 ft, Treasure Island 3–4 ft. Slow recovery: Fisherman's 8–10 ft, Shaw's still <10 ft Sun.
🟡 LA / SOUTH BAY → Least hit. PV ~15 ft, Redondo jetty 10 ft. Thermocline 65°F → 54°F at 25 ft.
🟢 CENTRAL COAST → REGIME CHANGE. Offshore wind blew the bloom out → Pt Lobos 40+ ft blue (50+ at depth), Monastery 30–35 ft, Cypress Pt 30 ft. 52°F at depth. Best window up here in a while.
🟢 MONTEREY BAY → Cleared too. McAbee 30 ft, Breakwater glassy blue ~20 ft, "the wall" 25 ft.
Heatwave: warm surface (67–70°F) over cold upwelling at depth (51–52°F) — same heatwave, opposite results by coast. New moon was 6/14 🌑
🔗 conditions.spearfactor.com . . . #spearfactor #diving #california #spearfishing

### WEEKLY EMAIL — Week of June 15–21, 2026
Subject line options (pick one):
- A tale of two coasts: SD soup clears, Central CA turns blue — Dive Report June 15–21
Preheader (preview text): San Diego started in pea soup and finished strong. Central CA flipped to blue water. Same heatwave, opposite results.
Hey divers,
Here's what California waters did this week.
The big theme was a genuine split down the coast. San Diego opened the week in pea soup — a stubborn surface bloom plus King-tide stirring dropped La Jolla to 0–5 ft midweek — then clawed its way back to the best water we'd seen in a while by Sunday. Up in Central California the script flipped entirely: offshore wind scoured the surface bloom out and Carmel/Pt Lobos went full blue-water. Same marine heatwave, opposite results, all driven by wind and coastline.

WILDLIFE NOTES: Leopard sharks moved back onto the Marine Room reef (schooling Saturday and Sunday), with sevengill and tope sightings, and lots of black sea bass.

THE WEEK BY REGION
🔴 SAN DIEGO
- Rough start, strong finish. 6/17 Marine Room to the Cove was 0–5 ft "soup" — a lingering bloom plus King-tide drainage stirring the shallows. White filament streaks still hanging around 5–7 ft on 6/19.
- Recovery came fast: 8–12 ft over sand by Friday, and by Sunday LJ Cove was the best of the week — clean 15–20 ft on the afternoon push.
- Classic inner-murk / outer-clean gradient all week — hazy in the shallows, clearing as you moved out and down.
- Big vertical split: a warm, murky 65–68°F surface lens sitting over genuinely clean 51–52°F water at depth (15–35 ft of visibility once you dropped through it at LJ Shores).
- Point Loma kelp ran 8–20 ft depending on the day. Offshore was the move: Coronado Islands and the 9 Mile Bank both ~30 ft.
🔴 ORANGE COUNTY
A big 18-second south swell (the worst-case direction for these coves) hammered Laguna on 6/16 — Shaw's was 0–5 ft and Treasure Island just 3–4 ft. Slow recovery after: Fisherman's came back to 8–10 ft by 6/18, but Shaw's was still struggling under 10 ft as late as Sunday. In south swell, Treasure Island, Shaw's, and Woods Cove are your most sheltered bets — and Crescent Bay Park gives you a free look at Seal Rock and Shaw's before you commit.
🟡 LA / SOUTH BAY
The South Bay shrugged most of this off. Palos Verdes ran ~15 ft (6/15), the Redondo jetty held 10 ft (6/19), and Veterans Park was in the 14–20 ft range. Expect a sharp thermocline — warm ~65°F up top dropping to 54°F by 25 ft.
🟢 CENTRAL COAST
The week's best story. Offshore wind scoured the surface bloom right out and Central California went clear: Pt Lobos hit 40+ ft of blue water (6/19) and 50+ ft at depth (6/20), Monastery ran 30–35 ft (6/17), and Cypress Point was a solid 30 ft (6/18). Water was a crisp 52°F at depth. If you've been waiting out the summer pea soup up here, this was your window.
🟢 MONTEREY BAY
The bay followed suit. McAbee was 30 ft (6/18 and again 6/20), Breakwater went glassy blue around 20 ft (6/19), and "the wall" held 25 ft. A genuinely nice stretch for Monterey shore diving.

FISH AND OFFSHORE INTEL
- Yellowtail went wide open at the La Jolla kelp beds on 6/17 — a tight early window (roughly 7–9 AM), fish from 7 to 30+ lbs, eating everything. If you want a shot at them shore-adjacent, the dawn window is the play.
- Offshore banks (Coronado Islands, 9 Mile) had small bonito but the yellowtail bite hadn't pushed out there yet — the kelp paddies and Catalina remain the more reliable day-trip targets.

THE MARINE HEATWAVE — READ THE WHOLE WATER COLUMN
The heatwave is still running the show, but the story is in the split:
- Surface: 67–70°F up and down the coast
- At depth: 51–52°F — that cold water is active upwelling
That contrast is exactly what drove the inverse-coast pattern this week. In San Diego the warm surface lens fed the bloom (green and murky up top, clean below). In Central CA the wind mixed it out and gave us blue. Plan for the bottom temp, not the surface — you'll punch through a sharp, cold thermocline either way.

🌑 MOON & KING TIDES
We're coming off the 6/14 new moon, and the King tides early in the week were a real factor down south — extreme tidal swings drained bays and lagoons and stirred the shallows into murk before things settled. White seabass favor the low-light edges around the new moon, so the early-week dawn windows were the smart play.
Stay safe and check the live conditions before you head out.
Real-time predictions: conditions.spearfactor.com
