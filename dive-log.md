...
- **"Engine block / crap patch" (8/10, after-work) — vis 15–25, 55°F at depth, thermocline 45–55°F ("temps back to normal").** GPS-nav dive, strong N current on the swim in. **Location not confidently identifiable** from the nicknames — likely a La Jolla canyon-area or Monterey structure dive. Logged for the record; NOT graded (unsure which spot) — will ask Bret.
