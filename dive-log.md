...
### 2026-08-14 (Fri) — SD gin-clear (Cove MATCH), LJ Shores reads HOT, Crescent mild under-call; + 8/13 backfill
- **La Jolla Cove — MATCH ✅ (gin-clear lift correct — genuinely clear this time).** SD shop (8/14): "Vis 20–25; SD averaging 15–20, **protected areas like La Jolla Cove closer to 25 ft**"; a 2nd shop: "10–20, slightly hazier blue water, inshore may drop as the tide pulls out." Tool `ljcove` **22–27** (ntu **0.05**, chl 0.56, **chlRecentMax down to 1.64** — the week's bloom has FADED). 25 sits in 22–27 → MATCH. **Key:** unlike 8/8 & 8/10 (stealth-haze over-call worries), today the water is *genuinely* gin-clear (chlRecentMax 1.64, not 6+), so the gin-clear lift firing to 22–27 is correct — good to see it working on a true clear day.
- **⚠️ La Jolla Shores — tool reads HOT (29–34); WATCH.** Tool `ljshores` **29–34** (ntu 0.05 → the gin-clear lift hits its top tier). **But BOTH shops today cap SD at ≤25** (one 20–25/Cove 25, one 10–20 hazier), and there's **no direct Shores diver number** to confirm 30+. Per divers-underestimate I won't hard-call it an over-call (open Shores can be gin-clear 30 on an ntu-0.05 day, and the 8/9 offshore canyon was 25–30 at higher ntu 0.34), but two independent shops pegging SD ≤25 is a soft signal the **ntu≈0.05 gin-clear tier may run a touch hot on the Shores.** 1 soft data point, no confirming/contradicting Shores diver → **WATCH, do not tune** (over-correction discipline). If Shores divers keep coming in below the 29–34 on ultra-low-ntu days, revisit the top tier.
