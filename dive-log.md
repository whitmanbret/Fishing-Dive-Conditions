...
**OVER-CALLS (3):**
- **San Carlos Beach / Monterey Breakwater — MISS ✗ (Monterey held-bloom DECAY over-call).** Two dives, almost flat, 60°F surface / 55°F at depth, **vis 6–10 ft** ("1.5–2.5 angel-shark lengths"); nice in the shallows but by 10–12' snotty enough to need a 3000-lumen light; angel shark at ~18', red octopus, foot-long sea hare. Tool `monterey` **12–17 ft (bloom)** — chl **decayed to 9.6** (from the 14.21 stored ~8/7). **The held-bloom decay (linear toward climo over 72h) let Monterey creep 3–5 → 12–17 while the bloom is PHYSICALLY STILL PRESENT (diver 6–10, snotty).** The satellite has been gapping, so no fresh read re-anchored the bloom, and chl ~9.6 lands in a viz tier (12–17) well above reality. This is a softer echo of the flip-flop — now driven by decay, not the client timeout. **The chl≈10 → 12–17 mapping is also steep** (chl 14 → 3–5, chl 9.6 → 12–17: a big jump across ~one tier). Watch item; options below.
